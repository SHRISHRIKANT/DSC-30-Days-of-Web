...
const add = document.getElementById("add").addEventListener('click',()=>{
    let id = document.getElementById("inputAddress").value;
    let name = document.getElementById("inputEmail4").value;
    db.ref("users/"+id).set({
        Name : name,
...
const get = document.getElementById("get").addEventListener('click',()=>{
    ...
    db.ref("users/"+id).on("value",snapshot=>{
        document.getElementById("inputEmail4").value =snapshot.val().Name;
    })
})
